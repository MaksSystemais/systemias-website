...
description: "Whilst recording timesheets is essential for project budget tracking, no one likes to spend time longer than necessary in recording, summarising and analysing. It is one of these admin tasks that should take minutes to complete!"
date: '2024-04-01'
...
# The solution - custom timesheets app
