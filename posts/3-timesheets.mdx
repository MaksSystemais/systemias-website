...
## Services provided
*   Custom Power Apps timesheet app
*   Integrated SharePoint backend
*   Defined and built key workflows
*   End-to-end process optimisation

| Category                 | Services Description                                    |
| ------                   | --------------------------------------------------------|
| Power App Microsoft 365  | Build a custom Power Apps - timesheet app               |
| SharePoint setup         | Integrated SharePoint backend                           |
| Company key workflows    | Defined and built key workflows                         |